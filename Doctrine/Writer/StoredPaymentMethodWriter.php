...
class StoredPaymentMethodWriter implements StoredPaymentMethodWriterInterface
{
    ...
    public function __invoke(PaymentMethod $adyenStoredPaymentMethod, Shop $shop): ImportResult
    {
        ...
        if (null !== $swPayment) {
            return ImportResult::success($shop, $adyenStoredPaymentMethod, ImportStatus::notChanged());
        }
        ...
        return ImportResult::success($shop, $adyenStoredPaymentMethod, ImportStatus::created());
    }
}
