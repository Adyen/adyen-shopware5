;(function ($) {
     ...
     * $.publish('plugin/AdyenPaymentCheckoutError/addError', 'Something went wrong');
     *
    ...
    $.plugin('adyen-checkout-error', {
        ...
        eventListeners: function () {
            var me = this;
            $.subscribe(me.getEventName('plugin/AdyenPaymentCheckoutError/addError'), $.proxy(me.onAddError, me));
            $.subscribe(me.getEventName('plugin/AdyenPaymentCheckoutError/cleanErrors'), $.proxy(me.onCleanErrors, me));
            $.subscribe(me.getEventName('plugin/AdyenPaymentCheckoutError/scrollToErrors'), $.proxy(me.onScrollTo, me));
        },
